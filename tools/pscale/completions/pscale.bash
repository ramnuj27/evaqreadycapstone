...
_pscale_branch_create()
{
    ...
    flags_completion+=("__pscale_handle_go_custom_completion")
    flags+=("--max-storage=")
    two_word_flags+=("--max-storage")
    flags+=("--min-storage=")
    two_word_flags+=("--min-storage")
    flags+=("--region=")
...
_pscale_traffic-control_budget_create()
{
    last_command="pscale_traffic-control_budget_create"
    ...
    flags+=("--rate=")
    two_word_flags+=("--rate")
    flags+=("--warning-threshold=")
    two_word_flags+=("--warning-threshold")
    flags+=("--api-token=")
    two_word_flags+=("--api-token")
    flags+=("--api-url=")
    two_word_flags+=("--api-url")
...
_pscale_traffic-control_budget_delete()
{
    last_command="pscale_traffic-control_budget_delete"
...
_pscale_traffic-control_budget_show()
{
    last_command="pscale_traffic-control_budget_show"
...
_pscale_traffic-control_budget_update()
{
    last_command="pscale_traffic-control_budget_update"
...
_pscale_traffic-control_budget()
{
    last_command="pscale_traffic-control_budget"
...
_pscale_traffic-control_rule_create()
{
    last_command="pscale_traffic-control_rule_create"
...
_pscale_traffic-control_rule_delete()
{
    last_command="pscale_traffic-control_rule_delete"
...
_pscale_traffic-control_rule()
{
    last_command="pscale_traffic-control_rule"
...
_pscale_traffic-control()
{
    last_command="pscale_traffic-control"
