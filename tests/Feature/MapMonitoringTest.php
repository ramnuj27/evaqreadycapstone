...
test('interactive map component uses live mapbox controls and browser location', function () {
    ...
    expect($component)
        ...
        ->toContain(
            ...
            'terrainOptions',
            'defaultTerrainMode',
            'applyPaleCityMapTreatment',
            'safelySetPaintProperty',
            'localBuildingBlockCollection',
            'syncLocalBuildingBlocks',
            'localBuildingSourceId',
            'localBuildingLayerId',
            'localBuildingShadowLayerId',
            'monitoring-local-building-blocks',
            'monitoring-local-3d-building-blocks',
            'monitoring-local-building-shadows',
            '#aebfd3',
            '#f6f2ed',
            '#f5f1df',
            '#f7f2de',
