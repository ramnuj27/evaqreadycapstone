...
type Props = { canRegister?: boolean; canResetPassword?: boolean };
type NavItem = { label: string; href: string };
type InfoCard = { title: string; description: string; icon: LucideIcon };
...
const featureCards: InfoCard[] = [
    {
        title: 'Real-time evacuee tracking',
        description:
            'Monitor arrivals, transfers, and safe-status updates the moment they happen.',
        icon: Radar,
    },
    {
        title: 'QR code identification',
        description:
            'Replace fragile paper lists with fast, reliable QR-based resident verification.',
        icon: QrCode,
    },
    {
        title: 'Barangay-based monitoring',
        description:
            'Keep every evacuation center organized by barangay for cleaner coordination and accountability.',
        icon: MapPinned,
    },
    {
        title: 'Admin dashboard analytics',
        description:
            'Track occupancy, response performance, and operational gaps through a single command view.',
        icon: ChartColumnBig,
    },
    {
        title: 'Emergency alerts',
        description:
            'Send critical advisories and preparedness reminders when communities need them most.',
        icon: BellRing,
    },
];
...
export default function Features({
    ...
    const howItWorksHref = howItWorksRoute.url();
    const contactHref = contactRoute.url();
                            ...
                            <div className="grid gap-12 lg:grid-cols-[1.02fr_0.98fr] lg:items-center">
                                <div>
                                    <p className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.05] px-4 py-2 text-xs font-semibold tracking-[0.24em] text-slate-200 uppercase shadow-[0_10px_30px_rgba(2,10,24,0.28)]">
                                        <Radar className="size-3.5 text-orange-300" />
                                        Feature Overview
                                    </p>
                                    <h1
                                        ...
                                        style={displayFont}
                                    >
                                        A dedicated features page for the tools
                                        that keep evacuation teams ready.
                                    </h1>
                                    <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300 sm:text-xl">
                                        EvaQReady now has a separate Features
                                        page so the full toolset and command
                                        capabilities are easier to review in
                                        one place.
                                    </p>
                                ...
                                <GlassPanel className="p-8">
                                    ...
                                    <h2
                                        ...
                                        style={displayFont}
                                    >
                                        A dashboard that turns check-ins into
                                        actionable response insight
                                    </h2>
                                    <p className="mt-4 max-w-lg text-base leading-7 text-slate-300">
                                        From field scanning to barangay-wide
                                        analytics, response teams can see who
                                        has arrived, where capacity is
                                        tightening, and which communities still
                                        need follow-up.
                                    </p>
                                    <div className="mt-8 grid gap-4">
                                        <div className="rounded-[24px] border border-white/10 bg-[#06192b]/85 p-5">
                                            ...
                                            <p className="mt-3 text-lg leading-7 text-white">
                                                Compare movement across
                                                communities without switching
                                        ...
                                        <div className="rounded-[24px] border border-white/10 bg-[#06192b]/85 p-5">
                                            ...
                                            <p className="mt-3 text-lg leading-7 text-white">
                                                Keep residents informed with
                                                timely advisories, transfer
                                                notices, and center updates.
                                            </p>
                                        </div>
                                    </div>
                                </GlassPanel>
                                ...
                                <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
                                    <div>
                                        ...
                                        <h2
                                            ...
                                            style={displayFont}
                                        >
                                            Review the features, then jump to
                                            the right public page when you need
                                            more context.
                                        </h2>
                                        <p className="mt-4 max-w-2xl text-base leading-7 text-slate-300">
                                            This page now stays focused on the
                                            feature set, while the separate How
                                            It Works and Contact pages stay in
                                            their own dedicated public screens.
                                        </p>
                                    </div>
